...
Tendo em conta este ataque, fazendo um análise STRIDE ao sistema verifica-se que as ameaças mais preponderantes são:

- Spoofing, pois dá para implantar ficheiros em computadores de outros utilizadores/pessoas;
- Information Disclosure, dada a possibilidade de nos ser concedido acesso a dados aos quais não temos direito;
- Tampering with Data, pois a integridade do programa pde ser comprometida;
- DoS, pois há situações em que ocorre o crash do programa;
- Elevation of Privilege, dado que o utilizador que corre o programa não é o nosso, havendo sempre a possibilidade de correr o programa como administrador.
