...
Uma vez feita esta análise (ver Secção~\ref{sec:seh}), viu-se uma vez mais que a modificação directa do EIP é impossível, e é necessário a alteração das rotinas de processamento de excepções.
